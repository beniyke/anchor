...
class CreateWalletFeeRuleTable extends BaseMigration
{
    ...
    {
        Schema::createIfNotExists('wallet_fee_rule', function (SchemaBuilder $table) {
            $table->id();
            ...
            $table->indexIfNotExist(['transaction_type', 'payment_processor'], 'idx_wallet_fee_rule_type_processor');
            $table->indexIfNotExist('currency', 'idx_wallet_fee_rule_currency');
            $table->indexIfNotExist('is_active', 'idx_wallet_fee_rule_active');
        });
    }
