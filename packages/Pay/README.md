...
| :------------------ | :---------------------------------- | :--------------------------------------------- |
| `PaymentSuccessful` | Webhook confirms successful payment | `PaymentTransaction`, `array $gatewayResponse` |
| `PaymentFailed`     | Webhook confirms failed payment     | `PaymentTransaction`, `?string $reason`        |
...
use Core\Event;
use Pay\Events\PaymentSuccessful;
...
class AppServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        Event::listen(PaymentSuccessful::class, OrderFulfillmentListener::class);
