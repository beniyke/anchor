...
class SMTP
{
    ...
    public function authenticate(
        ...
        if (array_key_exists('EHLO', $this->server_caps)) {
            ...
            if ($authtype !== null and ! in_array($authtype, $this->server_caps['AUTH'])) {
     ...
     * @param array|int $expect        One or more expected integer success codes
     *
     * @return bool True on success
     */
     ...
     *
     * @return bool|int The number of bytes sent to the server or false on error
     */
    public function client_send($data, $command = '')
    {
        // If SMTP transcripts are left enabled, or debug output is posted online
        // it can leak credentials, so hide credentials in all but lowest level
        if ($this->do_debug < self::DEBUG_LOWLEVEL and in_array($command, ['User & Password', 'Username', 'Password'], true)) {
