...
class TraceablePDO extends PDO
{
     ...
     *
     * @return bool|TraceablePDOStatement If the database server successfully prepares the statement,
     ...
     *
     * @return bool|TraceablePDOStatement PDO::query returns a PDOStatement object, or FALSE on
     *                                    failure.
     */
    #[ReturnTypeWillChange]
     ...
     *
     * @return bool|string A quoted string that is theoretically safe to pass into an SQL statement.
