 ...
 * </code>
 */
class Propel2Collector extends DataCollector implements AssetProvider, Renderable
{
    /**
    ...
    protected function getStatements($records, $config)
    {
        ...
        foreach ($records as $record) {
            ...
            $isSuccess = (strtolower($record['level_name']) === LogLevel::INFO);
    ...
    public function collect()
    {
        ...
        $failedStatement = count(array_filter($statements, function ($statement) {
            return $statement['is_success'] === false;
        }));
