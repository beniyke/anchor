 ...
 * </code>
 */
class NamespacedTwigProfileCollector extends DataCollector implements AssetProvider, Renderable
{
    /**
     * @var Profile
     */
    ...
    /**
     * @var Environment|LoaderInterface|null
     */
    private $loader;
     ...
     *
     * @param Environment|LoaderInterface $loaderOrEnv
     */
