...
abstract class AbstractEventDispatcherTest extends TestCase
{
    ...
    public function test_has_listeners_is_lazy()
    {
        $called = 0;
    ...
    public function test_dispatch_lazy_listener()
    {
        $called = 0;
    ...
    public function test_remove_finds_lazy_listeners()
    {
    ...
    public function test_priority_finds_lazy_listeners()
    {
        $test = new TestWithDispatcher();
        $factory = function () use ($test) {
            return $test;
    ...
    public function test_get_lazy_listeners()
    {
        $test = new TestWithDispatcher();
        $factory = function () use ($test) {
            return $test;
