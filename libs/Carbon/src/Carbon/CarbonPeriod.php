...
class CarbonPeriod extends DatePeriodBase implements Countable, JsonSerializable
{
    ...
    public function __construct(...$arguments)
    {
        ...
        foreach ($arguments as $argument) {
            ...
            } elseif (! isset($sortedArguments['recurrences']) && ! isset($sortedArguments['end']) && (is_int($argument) || is_float($argument))
                                                                && $argument >= 0
            ) {
     ...
     *
     * @param DateInterval|int|string|Unit $interval
     * @param string|Unit                  $unit     the unit of $interval if it's a number
     *
     ...
     *
     * @param Carbon|CarbonImmutable|CarbonPeriod|DateTimeInterface|string $rangeOrRangeStart
     * @param Carbon|CarbonImmutable|DateTimeInterface|string|null         $rangeEnd
     */
     ...
     *
     * @param Carbon|CarbonInterval|CarbonPeriod|DateInterval|DatePeriod|DateTimeInterface|string|null $date
     *
     * @return CarbonInterface
     */
