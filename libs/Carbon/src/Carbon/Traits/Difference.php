...
trait Difference
{
    ...
    /**
     * @param string|Unit                                   $unit     microsecond, millisecond, second, minute,
     ...
     * ```
     *
     * @param array|Carbon|DateTimeInterface|string|null $other   if array passed, will be used as parameters array, see $syntax below;
     *                                                            if null passed, now will be used as comparison reference;
     *                                                            if any other type, it will be converted to date and used as reference.
     * @param array|int                                  $syntax  if array passed, parameters will be extracted from it, the array may contains:
