...
trait Date
{
     ...
     *
     * @param Carbon|\Carbon\CarbonInterval|CarbonPeriod|DateInterval|DatePeriod|DateTimeInterface|string|null $date
     *
     * @return static
     */
    ...
    protected function getTranslatedFormByRegExp($baseKey, $keySuffix, $context, $subKey, $defaultValue)
    {
        ...
        if (
            $this->getTranslationMessage("$standaloneKey.$subKey") && (! $context || (($regExp = $this->getTranslationMessage("{$baseKey}_regexp")) && ! preg_match($regExp, $context)))
        ) {
            $key = $standaloneKey;
        }
