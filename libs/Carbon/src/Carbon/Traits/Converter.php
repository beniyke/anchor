...
trait Converter
{
     ...
     *
     * @param Carbon|CarbonImmutable|DateTimeInterface|int|null $end      period end date or recurrences count if int
     * @param DateInterval|int|string|null                      $interval period default interval or number of the given $unit
     ...
     * Create a iterable CarbonPeriod object from current date to a given end date (and optional interval).
     *
     * @param Carbon|CarbonImmutable|DateTimeInterface|null $end      period end date
     * @param DateInterval|int|string|null                  $interval period default interval or number of the given $unit
     * @param string|null                                   $unit     if specified, $interval must be an integer
     */
