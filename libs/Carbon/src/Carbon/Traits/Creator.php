...
trait Creator
{
    ...
    public function __construct(
        ...
        if (
            ($this->clock || (
                method_exists(static::class, 'hasTestNow') && method_exists(static::class, 'getTestNow') && static::hasTestNow()
     ...
     *                                               used instead.
     * @param DateTimeZone|int|string|null $timezone optional timezone for the new instance.
     *
     * @throws InvalidFormatException
     */
     ...
     * will be 0.
     *
     * @param DateTimeInterface|int|string|null $year
     * @param int|null                          $month
     * @param int|null                          $day
     * @param int|null                          $hour
     * @param int|null                          $minute
     * @param int|null                          $second
     * @param DateTimeZone|int|string|null      $timezone
     *
     * @throws InvalidFormatException
     */
    ...
    public static function rawCreateFromFormat(string $format, string $time, $timezone = null): ?static
    {
        ...
        /** @var Carbon|CarbonImmutable|null $mock */
     ...
     *
     * @param string                       $format     Datetime format
     * @param DateTimeZone|int|string|null $timezone   optional timezone
