...
trait Test
{
     ...
     *
     * @param Closure|DateTimeInterface|false|static|string|null $testNow real or mock Carbon instance
     */
     ...
     * instance is created.
     *
     * @return CarbonInterface|Closure|null the current instance used for testing
     */
