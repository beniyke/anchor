 ...
 * @property float|int|string $timestamp                seconds since the Unix Epoch
 ...
 * @method CarbonInterface months(int|Month $value)                                                                                                                                                                                                                      Set current instance month to the given value.
 * @method CarbonInterface month(int|Month $value)                                                                                                                                                                                                                       Set current instance month to the given value.
 * @method CarbonInterface setMonths(int|Month $value)                                                                                                                                                                                                                   Set current instance month to the given value.
 * @method CarbonInterface setMonth(int|Month $value)                                                                                                                                                                                                                    Set current instance month to the given value.
...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
     ...
     *
     * @throws BadMethodCallException|ReflectionException|Throwable|UnknownMethodException
     */
     ...
     * @return void
     *
     * @throws ReflectionException|UnknownSetterException
     */
     ...
     *
     * @param int|WeekDay|null $value new value for weekday if using as setter.
     */
     ...
     * @param int|Month $value new value for given unit
     */
