 ...
 * @method        $this          addWeeks(float|int $weeks)                                                                                                                 Add given number of weeks to the current interval
 * @method        $this          subWeeks(float|int $weeks)                                                                                                                 Subtract given number of weeks to the current interval
 * @method        $this          addDays(float|int $days)                                                                                                                   Add given number of days to the current interval
 * @method        $this          subDays(float|int $days)                                                                                                                   Subtract given number of days to the current interval
 * @method        $this          addHours(float|int $hours)                                                                                                                 Add given number of hours to the current interval
 * @method        $this          subHours(float|int $hours)                                                                                                                 Subtract given number of hours to the current interval
 * @method        $this          addMinutes(float|int $minutes)                                                                                                             Add given number of minutes to the current interval
 * @method        $this          subMinutes(float|int $minutes)                                                                                                             Subtract given number of minutes to the current interval
 * @method        $this          addSeconds(float|int $seconds)                                                                                                             Add given number of seconds to the current interval
 * @method        $this          subSeconds(float|int $seconds)                                                                                                             Subtract given number of seconds to the current interval
 * @method        $this          addMilliseconds(float|int $milliseconds)                                                                                                   Add given number of milliseconds to the current interval
 * @method        $this          subMilliseconds(float|int $milliseconds)                                                                                                   Subtract given number of milliseconds to the current interval
 * @method        $this          addMicroseconds(float|int $microseconds)                                                                                                   Add given number of microseconds to the current interval
 * @method        $this          subMicroseconds(float|int $microseconds)                                                                                                   Subtract given number of microseconds to the current interval
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
    ...
    public function __construct($years = null, $months = null, $weeks = null, $days = null, $hours = null, $minutes = null, $seconds = null, $microseconds = null)
    {
        ...
        try {
            ...
            try {
                ...
                if (
                    ((float) $this->y) !== $years || ((float) $this->m) !== $months || ((float) $this->d) !== $totalDays || ((float) $this->h) !== $hours || ((float) $this->i) !== $minutes || ((float) $this->s) !== $intervalSeconds || $intervalMicroseconds !== ((int) $microseconds)
                ) {
     ...
     *
     * @return array|DateInterval|int|mixed|string|null
     */
     ...
     *
     * @param Carbon|DateTimeInterface|mixed $start
     * @param Carbon|DateTimeInterface|mixed $end
     */
     ...
     *
     * @param Closure|DateInterval|int|mixed|string|Unit|null $interval interval or number of the given $unit
     * @param string|Unit|null                                $unit     if specified, $interval must be an integer
     * @param bool                                            $skipCopy set to true to return the passed object
     *                                                                  (without copying it) if it's already of the
     *                                                                  current class
     *
     ...
     * @param array  $parameters parameters list
     *
     * @return float|int|static|string
     *
    ...
    protected function getForHumansParameters($syntax = null, $short = false, $parts = self::NO_LIMIT, $options = null): array
    {
        ...
        $join = $default === '' ? '' : ' ';
        /** @var array|bool|string $altNumbers */
        $altNumbers = false;
        $aUnit = false;
        $minimumUnit = 's';
        $skip = [];
     ...
     * ```
     *
     * @param array|int $syntax  if array passed, parameters will be extracted from it, the array may contain:
    ...
    public function forHumans($syntax = null, $short = false, $parts = self::NO_LIMIT, $options = null): string
    {
        ...
        if ($method) {
            ...
            while (
                count($intervalValues->getNonZeroValues()) > $parts && ($count = count($keys = array_keys($intervalValues->getValuesSequence()))) > 1
            ) {
     ...
     *
     * @param DateTimeInterface|int|string ...$params Start date, [end date or recurrences] and optional settings.
     */
     ...
     *
     * @param DateInterval|string $unit
    ...
    public static function getDateIntervalSpec(DateInterval $interval, bool $microseconds = false, array $skip = []): string
    {
        ...
        if (
            $interval->days >= CarbonInterface::DAYS_PER_WEEK * CarbonInterface::WEEKS_PER_MONTH && (! isset($date[static::PERIOD_YEARS]) || count(array_intersect(['y', 'year', 'years'], $skip))) && (! isset($date[static::PERIOD_MONTHS]) || count(array_intersect(['m', 'month', 'months'], $skip)))
        ) {
            $date = [
     ...
     *
     *
     * @throws UnitNotConfiguredException|UnknownUnitException
     */
     ...
     *
     * @param DateInterval|float|int|string|null $precision
     *
     * @return $this
     *
     * @throws Exception
