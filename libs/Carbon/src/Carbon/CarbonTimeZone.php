...
class CarbonTimeZone extends DateTimeZone
{
     ...
     *
     * @param DateTimeZone|false|int|string|null $object     original value to get CarbonTimeZone from it.
     * @param DateTimeZone|false|int|string|null $objectDump dump of the object for error messages.
     *
     * @return static|null
     *
     ...
     * Create a CarbonTimeZone from mixed input.
     *
     * @param DateTimeZone|int|string|null $object
     *
     * @return false|static
     */
